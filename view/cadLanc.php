      ...
      <section class="wrapper">
          <div>
              <div style="float:left">
                <h3><i class="fa fa-angle-right"></i> Lançamentos </h3>
              </div>
            ...
            <div class="col-lg-12 pd-30">
              ...
              <div class="row sc" style="width:100%">
                  ...
                  <div style="float:right;width:50%">
                    <div style="float:right">
                      <h4>
                        <button class="btn btn-success btn-xs" onclick="window.location.href='../view/lanc.php'"><< Voltar <<</button>
                      </h4>
                    </div>
                  </div>
              </div>
...
<!-- FORM -->
              <form action="../controller/LancController.class.php?<?= isset($_GET['ID']) && !empty($_GET['ID']) ? 'acao=edit&ID='.$_GET['ID'].'' : 'acao=insert' ?>" method="post" enctype="multipart/form-data">
